...
| Go from Request to Production | Bilingual source-reading series that follows one HTTP request through Go language semantics, `net/http`, the runtime, the kernel boundary, production diagnostics, and version-upgrade boundaries. | [Gateway](https://rememorio.github.io/blog/go-runtime/) / [中文](https://rememorio.github.io/blog/go-runtime/zh/) / [English](https://rememorio.github.io/blog/go-runtime/en/) |
| AI Engineering | Bilingual engineering series grounded in Codex, Symphony, and Evals source. | [Gateway](https://rememorio.github.io/blog/ai-engineering/) / [中文](https://rememorio.github.io/blog/ai-engineering/zh/) / [English](https://rememorio.github.io/blog/ai-engineering/en/) |
...
| Claude Code Source Notes | Bilingual source-reading series on the March 31, 2026 [Claude Code mirror snapshot](https://github.com/Rememorio/claude-code/tree/5a774a2b62d7949c1d94e0b726281554d7893cfd), with official product contracts distinguished from snapshot behavior. | [Gateway](https://rememorio.github.io/blog/claude-code/) / [中文](https://rememorio.github.io/blog/claude-code/zh/) / [English](https://rememorio.github.io/blog/claude-code/en/) |
...
├── deepseek-harness/           # DeepSeek Harness source-reading series
│   ├── index.html              # Series language gateway
│   ├── assets/                 # Shared identifier-only mechanism figures
│   ├── zh/                     # Chinese route and articles
│   └── en/                     # English route and articles
...
├── self-evolution/             # Agent self-evolution series directory and project reading
│   ├── index.html              # Series language gateway
│   ├── zh/                     # Chinese index and localized overview
│   └── en/                     # English index and localized overview
├── skillopt-lite/              # Self-Evolution Part 1; established article URLs retained
